        ...
        for i in range(grid_size[0]):
            for j in range(grid_size[1]):
                ...
                if grid_array[step - 1][i][j] == BURNING:
                    ...
                    if BURNING in neighbors or random.random() < lightning_prob:
...
if __name__ == '__main__':
    ...
    lightning_prob = 0
    # other possibilities: diff tree densities, multiple tree types, firebreaks (areas that can't burn), variable burn rates, wind, probabilistic spreads, topography, etc.
